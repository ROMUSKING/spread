# Spreadsheet-Native ERP Technical Specification v0.14.3

**Date:** 2026-06-26  
**Status:** Phase 0 implementation-readiness baseline with v0.14.3 external-integration final-promotion closure
...
**Version note:** This is **v0.14.3**, not v1.0. Version 1.0 remains reserved for a release-candidate baseline after Phase 0 evidence exists.  
...
```text
- The v0.14.2 spec is archived; v0.14.3 is now the only active spec in /spec.
...
## v0.14.3 Final Promotion Closure: Version, Handoff, Credential, Observability, and Fixture Cleanup

v0.14.3 closes the v0.14.2 final-promotion review without widening MVP scope.

Normative additions:

```text
- Active README, pack-index, spec, SLOs, invariants, manifest, and validation now target v0.14.3.
...
docs/review/critical-review-v0.14.3.md
docs/dev/command-lifecycle.md
docs/security/integration-credential-management.md
docs/observability/phase0-observability.md
