# Spreadsheet-Native ERP Technical Specification v0.14.2

**Date:** 2026-06-26  
**Status:** Phase 0 implementation-readiness baseline with v0.14.2 external-integration and UI preparedness review closure
...
**Version note:** This is **v0.14.2**, not v1.0. Version 1.0 remains reserved for a release-candidate baseline after Phase 0 evidence exists.  
...
The v0.14.2 review closure synchronizes the main spec with the v0.14.1 security/UI closure, removes manifest duplication, expands integration handoff guidance, deepens credential/KMS/secret-scanning requirements, strengthens integration observability, adds a negative integration fixture, and keeps UI tiling explicitly post-vertical-slice.
...
```text
- Active spec path is v0.14.2 and is the only active spec in /spec.
