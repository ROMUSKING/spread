# START HERE — Spreadsheet-Native ERP v0.15.2 Architecture Snapshot
...
```text
1. Do not mutate operational state outside command handlers.
2. Do not bypass durable outbox polling for live updates or delivery.
3. Do not introduce TigerBeetle, pgvector, DuckDB, broker/CDC, or connector runtime into the Phase 0 edit path.
4. Do not display derived-plane candidates without RetrievalRevalidator.
5. Do not implement full tiling, autonomous AI writes, or external connector marketplace work before the vertical slice is green.
```
...
|---|---|
| Any contributor | `docs/snapshot-v0.15.2.md`, `README.md`, `docs/pack-index.md` |
