  ...
  constructor() {
    ...
    this.workspaceEdges = [
      ...
      },
      {
        ...
        source: '00000000-0000-0000-0000-000000000022',
        target: '00000000-0000-0000-0000-000000000010',
        label: 'variant for product_id',
      },
      {
        id: '00000000-0000-0000-0000-000000000231',
        source: '00000000-0000-0000-0000-000000000024',
        target: '00000000-0000-0000-0000-000000000011',
        label: 'extends customer details',
      },
      {
        id: '00000000-0000-0000-0000-000000000232',
        source: '00000000-0000-0000-0000-000000000025',
        target: '00000000-0000-0000-0000-000000000012',
        label: 'extends supplier details',
      },
      {
      ...
      },
      {
        ...
        source: '00000000-0000-0000-0000-000000000022',
        target: '00000000-0000-0000-0000-000000000014',
        label: 'stocks variant product_id',
      },
      {
      ...
      },
      {
        ...
        source: '00000000-0000-0000-0000-000000000103',
        target: '00000000-0000-0000-0000-000000000032',
        label: 'contains',
      },
      {
      ...
      },
      {
        ...
        source: '00000000-0000-0000-0000-000000000103',
        target: '00000000-0000-0000-0000-000000000013',
        label: 'contains',
      },
      {
      ...
      },
      {
        ...
        source: '00000000-0000-0000-0000-000000000101',
        target: '00000000-0000-0000-0000-000000000031',
        label: 'contains',
      },
      {
